...
has to be and why a skip is one. At the pinned tag it reports 1883 pass, 512 skip -- 200 upstream's,
255 blocked on request-time rendering and 57 waiting for an async pass -- and nothing failing. It takes twelve seconds.
