...
- `hooks.ts` output includes `useSeamDerive`/`useDerive` exports alongside query/mutation hooks
- Derive registry (`derive-registry.ts`) is generated by `seam-cli` (`ref_graph.rs`), not this crate
