...
pub fn generate_hooks_module() -> String {
	"// Auto-generated by seam. Do not edit.\n\
	 import { useSeamFetch as _useSeamFetch, useSeamQuery as _useSeamQuery, useSeamMutation as _useSeamMutation, useSeamDerive as _useSeamDerive } from \"@canmi/seam-query-react\";\n\
	 ...
	 export const useSeamDerive = _useSeamDerive;\n\
