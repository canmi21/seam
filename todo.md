...
- A test the render answers is not forced, 4 samples: a chain no test of which the request decides
  ...
  branch and evaluates nothing in the others (async-state-new-branch-3, async-state-new-branch-fork-2,
  -fork-3, -fork-5). spec/pipeline.md, "A test the render answers is not forced".
