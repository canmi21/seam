...
Implemented in: `packages/seam-react/src/sentinel.ts`
...
- Rust: `crates/seam-cli/src/build/skeleton.rs` (`sentinel_to_slots`)
- JS (test only): `packages/seam-react/__tests__/round-trip.test.ts` (`sentinelToSlots`)
