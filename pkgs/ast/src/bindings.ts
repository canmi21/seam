...
const GLOBALS = new Set([
	...
	'RegExp',
	'Set',
	// ECMAScript's own constructors and namespaces with no clock, locale or environment in them,
	// which every engine has, a backend's embedded one included.
	'Error',
	'AggregateError',
	'EvalError',
	'RangeError',
	...
	'BigInt64Array',
	'BigUint64Array',
	// Scheduling, which delays a value rather than supplying one: nothing read through these reaches
	// the bytes. A backend whose evaluator has no timers is that backend's to measure; see
	// spec/suite.md.
	'setTimeout',
	'clearTimeout',
	'queueMicrotask',
